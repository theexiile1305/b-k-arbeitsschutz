          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8 mb-16">
            <div className="bg-white rounded-xl p-6 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:+498171386711" className="text-bk-dark font-semibold hover:text-bk-light transition-colors">
                  +49 (0) 8171 38 67 11
                </a>
              </div>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:info@b-k-arbeitsschutz.de" className="text-bk-dark font-semibold hover:text-bk-light transition-colors">
